...
Implemented through Phase 7 — query executor:
...
the AST and parser. Phase 7 shipped collection-scan query execution. Next:
Phase 8 (the persistent B+ tree in `nova-index`).
